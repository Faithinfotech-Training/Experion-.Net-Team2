...
const routes: Routes = [
  ...
  { path: 'labtechnician', component: LabtechnicianComponent, canActivate:[AuthGuard], data:{role: '9'} },
  ...
  { path: 'patientregister', component: PatientRegisterHComponent, canActivate: [AuthGuard], data: { role: '10' } },
  { path: '', redirectTo: "/login", pathMatch: 'full' },
  { path: 'login', component: LoginComponent },  
  { path: 'staffs', component: StaffsComponent },
  { path: 'staff', component: StaffComponent, canActivate: [AuthGuard], data: { role: '9' } },
  { path: 'stafflist', component: StaffListComponent, canActivate: [AuthGuard], data: { role: '9' } },
  { path: 'staff/:staffId', component: StaffComponent, canActivate: [AuthGuard], data: { role: '9' } },
  { path: 'admin', component: AdminComponent, canActivate: [AuthGuard], data: { role: '9' } },
  { path: 'frontoffice', component: FrontofficeComponent, canActivate: [AuthGuard], data: { role: '10' } },  
  { path: 'doctorlist', component: DoctorListComponent },
  { path: 'doctorviewlabreportbydate', component: DoctorViewLabreportByDateComponent, canActivate: [AuthGuard], data: { role: '12' } },
  { path: 'doctorviewlabreportbyid', component: DoctorViewLabreportByIdComponent, canActivate: [AuthGuard], data: { role: '12' } },
  { path: 'appointment', component: AppointmentComponent, canActivate: [AuthGuard], data: { role: '10' } },
  { path: 'appointmentlist', component: AppointmentListComponent, canActivate: [AuthGuard], data: { role: '10' } },
  { path: 'addLogin', component: AddLoginComponent, canActivate: [AuthGuard], data: { role: '9' }},
  { path: 'editstaff/:staffId', component: EditStaffComponent},


  //{ path: 'appointmentlist', component: AppointmentListComponent },
  { path: 'addPrescription', component: AddPrescriptionComponent },
  { path: 'doctors', component: DoctorsComponent, canActivate: [AuthGuard], data: { role: '12' }},  
  {path:'doctorViewAppointmentForm', component:DoctorViewAppointmentsForDayFormComponent},
  {path: 'doctorListPatientsByDate', component:ListPatientsByDateComponent},
  {path: 'patientPrescriptionHistory', component: PatientPrescriptionHistoryComponent},
  {path: 'patientLabHistory', component: PatientLabHistoryComponent},
  ...
  {path: 'getpatient', component: PatientViewByIdHComponent, canActivate: [AuthGuard], data: { role: '10' }},
  {path: 'viewtest', component: ViewTestHComponent},
  {path: 'viewtechnician', component: ViewlabtechnicianhComponent, canActivate: [AuthGuard], data: { role: '9' }},
  {path: 'technicianhome', component: TechnicianhomepageComponent},
  {path: 'doctor', component: DoctorComponent,canActivate: [AuthGuard], data: { role: '9' }},
