...
const routes: Routes = [
  ...
  { path: 'labtechnician', component: LabtechnicianComponent, canActivate:[AuthGuard], data:{role: '5'} },
  ...
  { path: 'patientregister', component: PatientRegisterHComponent, canActivate: [AuthGuard], data: { role: '6' } },
  ...
  { path: 'frontoffice', component: FrontofficeComponent, canActivate: [AuthGuard], data: { role: '6' } },  
  { path: 'doctorlist', component: DoctorListComponent },
  { path: 'doctorviewlabreportbydate', component: DoctorViewLabreportByDateComponent, canActivate: [AuthGuard], data: { role: '8' } },
  { path: 'doctorviewlabreportbyid', component: DoctorViewLabreportByIdComponent, canActivate: [AuthGuard], data: { role: '8' } },
  { path: 'appointment', component: AppointmentComponent, canActivate: [AuthGuard], data: { role: '6' } },
  { path: 'appointmentlist', component: AppointmentListComponent, canActivate: [AuthGuard], data: { role: '6' } },
  { path: 'addLogin', component: AddLoginComponent, canActivate: [AuthGuard], data: { role: '5' }},
  { path: 'editstaff/:staffId', component: EditStaffComponent},


  //{ path: 'appointmentlist', component: AppointmentListComponent },
  { path: 'addPrescription', component: AddPrescriptionComponent },
  { path: 'doctors', component: DoctorsComponent, canActivate: [AuthGuard], data: { role: '8' }},  
  {path:'doctorViewAppointmentForm', component:DoctorViewAppointmentsForDayFormComponent},
  {path: 'doctorListPatientsByDate', component:ListPatientsByDateComponent},
  {path: 'patientPrescriptionHistory', component: PatientPrescriptionHistoryComponent},
  {path: 'patientLabHistory', component: PatientLabHistoryComponent},
  ...
  {path: 'getpatient', component: PatientViewByIdHComponent, canActivate: [AuthGuard], data: { role: '6' }},
  {path: 'viewtest', component: ViewTestHComponent},
  {path: 'viewtechnician', component: ViewlabtechnicianhComponent, canActivate: [AuthGuard], data: { role: '5' }},
  {path: 'technicianhome', component: TechnicianhomepageComponent},
  {path: 'doctor', component: DoctorComponent,canActivate: [AuthGuard], data: { role: '5' }},
